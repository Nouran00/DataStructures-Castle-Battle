...
enum CASTLE_STATUS	//castle status
{
		
	ACTIV,	//Active (able to attack enemies)
	FROSTED,	//Frosted (cannot attack enemies )
	KILLED,	//Killed caslte (game lost)
	CASTLE_STATUS_CNT	//Status count
};
